...
You have ${newScore} ${newResult}, ${valueOne} ${outcomeOne}, and ${valueTwo} ${outcomeTwo}`);
    ...
    rockMove.innerHTML = (`You - <img src="./images/rock.jpg" alt=""> : <img src="./images/${computerMove}.jpg" alt=""> - Computer`);
...
You have ${newScore} ${newResult}, ${valueOne} ${outcomeOne}, and ${valueTwo} ${outcomeTwo}`;
    ...
    paperMove.innerHTML = (`You - <img src="./images/paper.jpg" alt=""> : <img src="./images/${computerMove}.jpg" alt=""> - Computer`);
...
You have ${newScore} ${newResult}, ${valueOne} ${outcomeOne}, and ${valueTwo} ${outcomeTwo}`);
    ...
    scissorsMove.innerHTML = (`You - <img src="./images/scissors.jpg" alt=""> : <img src="./images/${computerMove}.jpg" alt=""> - Computer`);
